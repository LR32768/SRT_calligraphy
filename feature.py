...
#Now strech feature 1(convexarea / rectanglearea);
    ...
    #Now stretch feature 15 (gap and white space distribution index)
    feature[15] = white_distribute(img)
    ...
    #print(tmpx)
    #print(tmpy)
    feature[16] = (tmpx[blackpixels // 4] - xmin) / height
    feature[17] = (tmpx[blackpixels // 4 * 3] - xmin) / height
    feature[18] = (tmpy[blackpixels // 4] - ymin) / width
    feature[19] = (tmpy[blackpixels // 4 * 3] - ymin) / width

    return(feature)

featurelist = feature_stretch('2.jpg')
print(featurelist)
